...
if (cards) {
  ...
  const heartIcon = '<svg class="favorite-heart-icon" viewBox="0 0 24 24" aria-hidden="true"><path d="M12 20.4 4.2 13A5.2 5.2 0 0 1 11.5 5.6l.5.5.5-.5A5.2 5.2 0 0 1 19.8 13L12 20.4Z"/></svg>';
