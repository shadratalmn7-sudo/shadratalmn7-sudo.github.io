...
const contentAccess={editor:['admin-scholarships.html','admin-services.html','admin-offers.html','admin-videos.html'],admin:['admin-scholarships.html','admin-services.html','admin-offers.html','admin-videos.html','admin-announcements.html']};
if(role!=='owner')document.querySelectorAll('.content-link').forEach(link=>{if(!(contentAccess[role]||[]).includes(link.getAttribute('href')))link.remove()});
