(() => {
  ...
  const publicModules=async()=>{
    load('./push-notifications.js?v=5','web push');
    const routes={
    ...
    await routes[page]?.();
    onIdle(()=>{if(!['login.html','register.html'].includes(page))load('./nav-auth.js?v=104','navigation account state');load('./analytics.js?v=10','analytics');if(!['login.html','register.html','terms.html','privacy.html'].includes(page))load('./notifications-live.js?v=15','notifications');load('./ads.js?v=2','ads')});
  };
