(() => {
  ...
  const publicModules = async () => {
    const routes = {
      ...
      'services.html': () => load('./public-commerce-live.js?v=10', 'services'),
      'offers.html': () => load('./public-commerce-live.js?v=10', 'offers'),
  ...
  const adminModules = async () => {
    try {
      ...
      const routes = {
        ...
        'admin-services.html': './admin-commerce.js?v=10',
        'admin-offers.html': './admin-commerce.js?v=10',
        'admin-orders.html': './admin-orders.js?v=10',
        'admin-messages.html': './admin-messages.js?v=10',
        'admin-announcements.html': './admin-announcements.js?v=10'
      };
